...
FLASH_SIZE = 64
else ifeq ($(TARGET),$(filter $(TARGET),NAZE CC3D ALIENWIIF1 SPRACINGF3 OLIMEXINO BRUSHEDFC))
FLASH_SIZE = 128
...
ifeq ($(TARGET),BRUSHEDFC)
TARGET_FLAGS := $(TARGET_FLAGS) -DNAZE -DALIENWII32
TARGET_DIR = $(ROOT)/src/main/target/BRUSHEDFC
endif
